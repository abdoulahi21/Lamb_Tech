    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 hover:bg-gradient-to-br shadow-2xl rounded-xl p-4">
            <div class="flex items center">
                ...
                <div class="flex-1">
                    <h5 class="font-bold text-2xl">
                        {{ /*$incompletedPersonalPlannings*/ 7 }}
                    </h5>
                    <h5 class="font-bold text-lg">
            ...
            series: [
                {
                    ...
                    data: /*completedPersonalPlanningsByWeek*/ [10, 20, 30, 40, 50, 60, 70],
                    color: "#1A56DB",
                },
                {
                    name: "Taches Incomplétées",
                    data: /*incompletedPersonalPlanningsByWeek*/ [70, 60, 50, 40, 30, 20, 10],
                    color: "#F05252",
                },
            ],
            legend: {
