...
@section('content')
    ...
    <header class="bg-gray-50 dark:bg-gray-800 py-16 px-4 sm:py-24 sm:px-6 lg:py-32 lg:px-8" style="background-image: url('{{ asset("assets/home.png") }}'); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <!-- Header content here -->
        <div class="max-w-screen-xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:py-32 lg:px-8">
            <div class="text-center">
                ...
                <p class="mt-6 text-xl text-gray-200 dark:text-gray-400">IT~SN est une plateforme de gestion d'établissement</p>
        ...
        <div class="max-w-screen-xl mx-auto  px-4 sm:py-24 sm:px-6  lg:px-8" id="1">
            <div class="grid grid-cols-1 gap-16 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-12">
                <div class="flex flex-col items-center space-y-6">
                    ...
                    <h2 class="text-2xl font-extrabold text-gray-900 dark:text-white">Gestion des éleves</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400">Gérez les éleves de votre établissement</p>
                </div>
                <div class="flex flex-col items-center space-y-6">
                    <div class="flex items center justify-center w-16 h-16 rounded-lg bg-blue-100 dark:bg-blue-700">
                        <svg class="w-8 h-8 text-blue-600 dark:text-blue-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <h2 class="text-2xl font-extrabold text-gray-900 dark:text-white">Gestion des inscriptions</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400">Gérez les inscriptions de vos éleves</p>
                </div>
                <div class="flex flex-col items-center space-y-6">
                    <div class="flex items center justify-center w-16 h-16 rounded-lg bg-blue-100 dark:bg-blue-700">
                        <svg class="w-8 h-8 text-blue-600 dark:text-blue-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <h2 class="text-2xl font-extrabold text-gray-900 dark:text-white">Gestion des relevés</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400">Gérez les de relevés vos éleves</p>
                </div>
            </div>
        </div>
    </div>
